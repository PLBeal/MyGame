...
public class Player extends Entity{
    ...
    public void getPlayerImage() {
        try {
            ...
            down1 = ImageIO.read(Objects.requireNonNull(getClass().
                    getResourceAsStream("/player/boy_down_1.png")));
            down2 = ImageIO.read(Objects.requireNonNull(getClass().
                    getResourceAsStream("/player/boy_down_2.png")));
    ...
    public void update() {
        ...
        if (keyH.upPressed == true || keyH.leftPressed == true ||
            ...
            //the method is called 60 times per second, so the sprite changes 6 times per second
            spriteCounter++;
            if (spriteCounter > 12) {
                if (spriteNum == 1) {
                    spriteNum = 2;
